...
class EditItems extends BaseAction {
     ...
     */
    @Override
    public void execute(final Input anInput, final Tracker aTracker) {
        System.out.println();
...
public class MenuTracker {
     ...
     * @param aTracker Tracker.
     */
    public MenuTracker(final Input anInput, final Tracker aTracker) {
        this.input = anInput;
    ...
    private class AddItem extends BaseAction {
         ...
         */
        @Override
        public final void execute(final Input anInput, final Tracker aTracker) {
            System.out.println();
            System.out.println("------------ "
    ...
    private class FindItemByName extends BaseAction {
        ...
        public void execute(final Input anInput, final Tracker aTracker) {
            ...
            for (Item item : aTracker.findByName(name)) {
                System.out.println(String.format(
                        "%s. %s %s",
                        item.getId(),
                        item.getName(),
